...
<tr><td  colspan=2 class="FlawDimensions FlawDimensionsSpacing" id="CircumferentialSpacingRow"><span class="WithHints" title="Spacing"      >Circumferential Spacing (&Delta;C):</span>    <input class="updateDisplay" id="CircumferentialSpacing" size=5 type="text" value="1.5" size=5>       <span class="LengthUnits"></span></td></tr>
<tr><td  colspan=2 class="FlawDimensions FlawDimensionsSpacing" id="LongitudinalSpacingRow"><span class="WithHints" title="Spacing"      >Longitudinal Spacing (&Delta;S):</span>    <input class="updateDisplay" id="LongitudinalSpacing" size=5 type="text" value="1.5" size=5>       <span class="LengthUnits"></span></td></tr>
